...
```sh
npx -y @deepseek-ai/dsh plugin --profile web add @flyzstu/modsearch@5.11.2
```
...
```sh
npx -y @flyzstu/modsearch@5.11.2 doctor
```
...
```sh
npx -y @deepseek-ai/dsh plugin --profile <name> add @flyzstu/modsearch@5.11.2
```
