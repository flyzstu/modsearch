...
- **🥇 The strongest free web search plugin for DeepSeek Harness (dsh):** one command installs it, `npx -y @deepseek-ai/dsh plugin --profile web add @flyzstu/modsearch@5.11.2`. Details in [harness setup](docs/harness-setup.md#deepseek-harness-dsh).
