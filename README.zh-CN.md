...
<p align="center">引擎：<b>Firecrawl</b>（免注册，默认）· <b>Antigravity CLI</b> · <b>Ollama Cloud</b> · <b>Brave</b> · <b>Tavily</b> · <b>Exa</b> · <b>Grok（X）</b> · <b>local</b>，自动故障转移</p>
...
**第二步（可选），再加免费引擎。** Antigravity CLI 的综述质量更高，Ollama、Brave、Tavily、Exa 或免费 Firecrawl key 能在免注册额度之上再加一份个人额度，都不要求绑卡。只有 agy 的浏览器登录需要你亲手完成：
...
选了 key 的话，发一句话给 AI 即可：「把我的 ollama key 设成 ...」或「把我的 brave key 设成 ...」。
...
ModSearch 以 MIT 许可发布，使用不受限制。本项目不对任何用途（含商业使用）提供保证与背书。上游引擎（Ollama、Brave、Antigravity CLI、Tavily、Exa、Firecrawl、Grok Build）各有自己的条款与额度，遵守这些约束由使用者负责。
